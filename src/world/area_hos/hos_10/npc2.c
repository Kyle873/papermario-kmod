...
NpcData N(NpcData_Spirits)[] = {
    ...
    {
        .id = NPC_Eldstar,
        .pos = { GEN_NPC_ELDSTAR_1_VEC },
        .yaw = GEN_NPC_ELDSTAR_1_DIR,
        .territory = GEN_NPC_ELDSTAR_1_TERRITORY,
    ...
    {
        .id = NPC_Mamar,
        .pos = { GEN_NPC_MAMAR_1_VEC },
        .yaw = GEN_NPC_MAMAR_1_DIR,
        .territory = GEN_NPC_MAMAR_1_TERRITORY,
    ...
    {
        .id = NPC_Skolar,
        .pos = { GEN_NPC_SKOLAR_1_VEC },
        .yaw = GEN_NPC_SKOLAR_1_DIR,
        .territory = GEN_NPC_SKOLAR_1_TERRITORY,
    ...
    {
        .id = NPC_Muskular,
        .pos = { GEN_NPC_MUSKULAR_1_VEC },
        .yaw = GEN_NPC_MUSKULAR_1_DIR,
        .territory = GEN_NPC_MUSKULAR_1_TERRITORY,
    ...
    {
        .id = NPC_Misstar,
        .pos = { GEN_NPC_MISSTAR_1_VEC },
        .yaw = GEN_NPC_MISSTAR_1_DIR,
        .territory = GEN_NPC_MISSTAR_1_TERRITORY,
    ...
    {
        .id = NPC_Klevar,
        .pos = { GEN_NPC_KLEVAR_1_VEC },
        .yaw = GEN_NPC_KLEVAR_1_DIR,
        .territory = GEN_NPC_KLEVAR_1_TERRITORY,
    ...
    {
        .id = NPC_Kalmar,
        .pos = { GEN_NPC_KALMAR_1_VEC },
        .yaw = GEN_NPC_KALMAR_1_DIR,
        .territory = GEN_NPC_KALMAR_1_TERRITORY,
