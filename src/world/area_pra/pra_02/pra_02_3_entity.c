...
EvtScript N(EVS_MakeEntities) = {
    ...
    IfEq(GF_PRA02_UnlockedRedDoor, FALSE)
        EVT_MAKE_ENTITY(Padlock, GEN_PADLOCK_5_PARAMS)
        ...
        EVT_MAKE_ENTITY(Padlock, GEN_PADLOCK_6_PARAMS)
        Call(AssignScript, Ref(N(EVS_UsePadlock_Dummy)))
    ...
    IfEq(GF_PRA02_UnlockedBlueDoor, FALSE)
        EVT_MAKE_ENTITY(Padlock, GEN_PADLOCK_7_PARAMS)
        Call(AssignScript, Ref(N(EVS_UsePadlock_Dummy)))
        ...
        Add(LVar2, 1)
        Call(UseDynamicShadow, TRUE)
        EVT_MAKE_ENTITY(Padlock, GEN_PADLOCK_8_PARAMS)
        Call(AssignScript, Ref(N(EVS_UsePadlock_Dummy)))
