...
NpcData N(NpcData_Monstar) = {
    .id = NPC_Monstar,
    .pos = { GEN_NPC_MONSTAR_VEC },
    .yaw = GEN_NPC_MONSTAR_DIR,
    .territory = GEN_NPC_MONSTAR_TERRITORY,
...
NpcData N(NpcData_StarKids)[] = {
    {
        .id = NPC_StarKid_01,
        .pos = { GEN_NPC_STAR_KID_01_VEC },
        .yaw = GEN_NPC_STAR_KID_01_DIR,
        .territory = GEN_NPC_STAR_KID_01_TERRITORY,
    ...
    {
        .id = NPC_StarKid_02,
        .pos = { GEN_NPC_STAR_KID_02_VEC },
        .yaw = GEN_NPC_STAR_KID_02_DIR,
        .territory = GEN_NPC_STAR_KID_02_TERRITORY,
        .init = &N(EVS_NpcInit_StarKid),
        .settings = &N(NpcSettings_Twink),
        .flags = BASE_PASSIVE_FLAGS | ENEMY_FLAG_IGNORE_PLAYER_COLLISION,
        .drops = NO_DROPS,
    ...
    {
        .id = NPC_StarKid_03,
        .pos = { GEN_NPC_STAR_KID_03_VEC },
        .yaw = GEN_NPC_STAR_KID_03_DIR,
        .territory = GEN_NPC_STAR_KID_03_TERRITORY,
        .init = &N(EVS_NpcInit_StarKid),
        .settings = &N(NpcSettings_Twink),
        .flags = BASE_PASSIVE_FLAGS | ENEMY_FLAG_IGNORE_PLAYER_COLLISION,
        .drops = NO_DROPS,
    ...
    {
        .id = NPC_StarKid_04,
        .pos = { GEN_NPC_STAR_KID_04_VEC },
        .yaw = GEN_NPC_STAR_KID_04_DIR,
        .territory = GEN_NPC_STAR_KID_04_TERRITORY,
        .init = &N(EVS_NpcInit_StarKid),
        .settings = &N(NpcSettings_Twink),
        .flags = BASE_PASSIVE_FLAGS | ENEMY_FLAG_IGNORE_PLAYER_COLLISION,
        .drops = NO_DROPS,
    ...
    {
        .id = NPC_StarKid_05,
        .pos = { GEN_NPC_STAR_KID_05_VEC },
        .yaw = GEN_NPC_STAR_KID_05_DIR,
        .territory = GEN_NPC_STAR_KID_05_TERRITORY,
        .init = &N(EVS_NpcInit_StarKid),
        .settings = &N(NpcSettings_Twink),
        .flags = BASE_PASSIVE_FLAGS | ENEMY_FLAG_IGNORE_PLAYER_COLLISION,
        .drops = NO_DROPS,
    ...
    {
        .id = NPC_StarKid_06,
        .pos = { GEN_NPC_STAR_KID_06_VEC },
        .yaw = GEN_NPC_STAR_KID_06_DIR,
        .territory = GEN_NPC_STAR_KID_06_TERRITORY,
        .init = &N(EVS_NpcInit_StarKid),
        .settings = &N(NpcSettings_Twink),
        .flags = BASE_PASSIVE_FLAGS | ENEMY_FLAG_IGNORE_PLAYER_COLLISION,
        .drops = NO_DROPS,
    ...
    {
        .id = NPC_StarKid_07,
        .pos = { GEN_NPC_STAR_KID_07_VEC },
        .yaw = GEN_NPC_STAR_KID_07_DIR,
        .territory = GEN_NPC_STAR_KID_07_TERRITORY,
        .init = &N(EVS_NpcInit_StarKid),
        .settings = &N(NpcSettings_Twink),
        .flags = BASE_PASSIVE_FLAGS | ENEMY_FLAG_IGNORE_PLAYER_COLLISION,
        .drops = NO_DROPS,
    ...
    {
        .id = NPC_StarKid_08,
        .pos = { GEN_NPC_STAR_KID_08_VEC },
        .yaw = GEN_NPC_STAR_KID_08_DIR,
        .territory = GEN_NPC_STAR_KID_08_TERRITORY,
        .init = &N(EVS_NpcInit_StarKid),
        .settings = &N(NpcSettings_Twink),
        .flags = BASE_PASSIVE_FLAGS | ENEMY_FLAG_IGNORE_PLAYER_COLLISION,
        .drops = NO_DROPS,
    ...
    {
        .id = NPC_StarKid_09,
        .pos = { GEN_NPC_STAR_KID_09_VEC },
        .yaw = GEN_NPC_STAR_KID_09_DIR,
        .territory = GEN_NPC_STAR_KID_09_TERRITORY,
        .init = &N(EVS_NpcInit_StarKid),
        .settings = &N(NpcSettings_Twink),
        .flags = BASE_PASSIVE_FLAGS | ENEMY_FLAG_IGNORE_PLAYER_COLLISION,
        .drops = NO_DROPS,
    ...
    {
        .id = NPC_StarKid_10,
        .pos = { GEN_NPC_STAR_KID_10_VEC },
        .yaw = GEN_NPC_STAR_KID_10_DIR,
        .territory = GEN_NPC_STAR_KID_10_TERRITORY,
        .init = &N(EVS_NpcInit_StarKid),
        .settings = &N(NpcSettings_Twink),
        .flags = BASE_PASSIVE_FLAGS | ENEMY_FLAG_IGNORE_PLAYER_COLLISION,
        .drops = NO_DROPS,
    ...
    {
        .id = NPC_StarKid_11,
        .pos = { GEN_NPC_STAR_KID_11_VEC },
        .yaw = GEN_NPC_STAR_KID_11_DIR,
        .territory = GEN_NPC_STAR_KID_11_TERRITORY,
        .init = &N(EVS_NpcInit_StarKid),
        .settings = &N(NpcSettings_Twink),
        .flags = BASE_PASSIVE_FLAGS | ENEMY_FLAG_IGNORE_PLAYER_COLLISION,
        .drops = NO_DROPS,
    ...
    {
        .id = NPC_StarKid_12,
        .pos = { GEN_NPC_STAR_KID_12_VEC },
        .yaw = GEN_NPC_STAR_KID_12_DIR,
        .territory = GEN_NPC_STAR_KID_12_TERRITORY,
        .init = &N(EVS_NpcInit_StarKid),
        .settings = &N(NpcSettings_Twink),
        .flags = BASE_PASSIVE_FLAGS | ENEMY_FLAG_IGNORE_PLAYER_COLLISION,
        .drops = NO_DROPS,
    ...
    {
        .id = NPC_StarKid_13,
        .pos = { GEN_NPC_STAR_KID_13_VEC },
        .yaw = GEN_NPC_STAR_KID_13_DIR,
        .territory = GEN_NPC_STAR_KID_13_TERRITORY,
        .init = &N(EVS_NpcInit_StarKid),
        .settings = &N(NpcSettings_Twink),
        .flags = BASE_PASSIVE_FLAGS | ENEMY_FLAG_IGNORE_PLAYER_COLLISION,
        .drops = NO_DROPS,
    ...
    {
        .id = NPC_StarKid_14,
        .pos = { GEN_NPC_STAR_KID_14_VEC },
        .yaw = GEN_NPC_STAR_KID_14_DIR,
        .territory = GEN_NPC_STAR_KID_14_TERRITORY,
        .init = &N(EVS_NpcInit_StarKid),
        .settings = &N(NpcSettings_Twink),
        .flags = BASE_PASSIVE_FLAGS | ENEMY_FLAG_IGNORE_PLAYER_COLLISION,
        .drops = NO_DROPS,
    ...
    {
        .id = NPC_StarKid_15,
        .pos = { GEN_NPC_STAR_KID_15_VEC },
        .yaw = GEN_NPC_STAR_KID_15_DIR,
        .territory = GEN_NPC_STAR_KID_15_TERRITORY,
        .init = &N(EVS_NpcInit_StarKid),
        .settings = &N(NpcSettings_Twink),
        .flags = BASE_PASSIVE_FLAGS | ENEMY_FLAG_IGNORE_PLAYER_COLLISION,
        .drops = NO_DROPS,
    ...
    {
        .id = NPC_StarKid_16,
        .pos = { GEN_NPC_STAR_KID_16_VEC },
        .yaw = GEN_NPC_STAR_KID_16_DIR,
        .territory = GEN_NPC_STAR_KID_16_TERRITORY,
        .init = &N(EVS_NpcInit_StarKid),
        .settings = &N(NpcSettings_Twink),
        .flags = BASE_PASSIVE_FLAGS | ENEMY_FLAG_IGNORE_PLAYER_COLLISION,
        .drops = NO_DROPS,
