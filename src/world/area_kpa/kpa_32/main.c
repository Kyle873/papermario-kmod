...
EvtScript N(EVS_Main) = {
    ...
    Call(SetTexPanner, MODEL_o1287, TEX_PANNER_1)
    Call(SetTexPanner, MODEL_o1289, TEX_PANNER_1)
    Call(SetTexPanner, MODEL_o1293, TEX_PANNER_1)
    Call(SetTexPanner, MODEL_o1295, TEX_PANNER_1)
    Thread
        GEN_TEX_PANNER_1
