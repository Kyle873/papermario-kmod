...
EvtScript N(D_80240F84_A53844) = {
    ...
    Call(SetTexPanner, MODEL_o1816, TEX_PANNER_0)
    Call(SetTexPanner, MODEL_o1817, TEX_PANNER_0)
    Call(SetTexPanner, MODEL_o1818, TEX_PANNER_0)
    Call(SetTexPanner, MODEL_o1819, TEX_PANNER_0)
    Call(SetTexPanner, MODEL_o1820, TEX_PANNER_0)
    Call(SetTexPanner, MODEL_o1821, TEX_PANNER_0)
    Call(SetTexPanner, MODEL_o1822, TEX_PANNER_0)
    Call(SetTexPanner, MODEL_o1823, TEX_PANNER_0)
    Call(SetTexPanner, MODEL_o1824, TEX_PANNER_0)
    Call(SetTexPanner, MODEL_o1825, TEX_PANNER_0)
    Call(SetTexPanner, MODEL_o1826, TEX_PANNER_0)
    Call(SetTexPanner, MODEL_o1827, TEX_PANNER_0)
    Call(SetTexPanner, MODEL_o1828, TEX_PANNER_0)
    Call(SetTexPanner, MODEL_o1829, TEX_PANNER_0)
    Return
    End
};

LavaReset N(SafeFloorColliders)[] = {
    { .colliderID = COLLIDER_o1234, .pos = { GEN_LAVA_RESET_O1234_VEC }},
