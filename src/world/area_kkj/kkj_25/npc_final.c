...
NpcData N(NpcData_Bowser) = {
    .id = NPC_Bowser_03,
    .pos = { GEN_NPC_BOWSER_03_VEC },
    .yaw = GEN_NPC_BOWSER_03_DIR,
    .territory = GEN_NPC_BOWSER_03_TERRITORY,
...
NpcData N(NpcData_Peach) = {
    .id = NPC_Peach_02,
    .pos = { GEN_NPC_PEACH_02_VEC },
    .yaw = GEN_NPC_PEACH_02_DIR,
    .territory = GEN_NPC_PEACH_02_TERRITORY,
...
NpcData N(NpcData_Kammy) = {
    .id = NPC_Kammy_05,
    .pos = { GEN_NPC_KAMMY_05_VEC },
    .yaw = GEN_NPC_KAMMY_05_DIR,
    .territory = GEN_NPC_KAMMY_05_TERRITORY,
...
NpcData N(NpcData_Twink) = {
    .id = NPC_Twink_02,
    .pos = { GEN_NPC_TWINK_02_VEC },
    .yaw = GEN_NPC_TWINK_02_DIR,
    .territory = GEN_NPC_TWINK_02_TERRITORY,
