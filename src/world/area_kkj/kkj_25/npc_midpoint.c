...
NpcData N(NpcData_Bowser) = {
    .id = NPC_Bowser_02,
    .pos = { GEN_NPC_BOWSER_02_VEC },
    .yaw = GEN_NPC_BOWSER_02_DIR,
    .territory = GEN_NPC_BOWSER_02_TERRITORY,
...
NpcData N(NpcData_Peach) = {
    .id = NPC_Peach_01,
    .pos = { GEN_NPC_PEACH_01_VEC },
    .yaw = GEN_NPC_PEACH_01_DIR,
    .territory = GEN_NPC_PEACH_01_TERRITORY,
...
NpcData N(NpcData_Kammy)[] = {
    {
        .id = NPC_Kammy_03,
        .pos = { GEN_NPC_KAMMY_03_VEC },
        .yaw = GEN_NPC_KAMMY_03_DIR,
        .territory = GEN_NPC_KAMMY_03_TERRITORY,
    ...
    {
        .id = NPC_Kammy_04,
        .pos = { GEN_NPC_KAMMY_04_VEC },
        .yaw = GEN_NPC_KAMMY_04_DIR,
        .territory = GEN_NPC_KAMMY_04_TERRITORY,
...
NpcData N(NpcData_Twink) = {
    .id = NPC_Twink_01,
    .pos = { GEN_NPC_TWINK_01_VEC },
    .yaw = GEN_NPC_TWINK_01_DIR,
    .territory = GEN_NPC_TWINK_01_TERRITORY,
