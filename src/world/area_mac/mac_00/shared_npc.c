...
NpcData N(NpcData_SharedTownsfolk)[] = {
    ...
    {
        .id = NPC_FickleLover,
        .pos = { GEN_NPC_FICKLE_LOVER_VEC },
        .yaw = GEN_NPC_FICKLE_LOVER_DIR,
        .territory = GEN_NPC_FICKLE_LOVER_TERRITORY,
    ...
    },
    {
        ...
        .pos = { GEN_NPC_SHAMELESS_LOVER_VEC },
        .yaw = GEN_NPC_SHAMELESS_LOVER_DIR,
        .territory = GEN_NPC_SHAMELESS_LOVER_TERRITORY,
    ...
    {
        .id = NPC_KrisT,
        .pos = { GEN_NPC_KRIS_T_VEC },
        .yaw = GEN_NPC_KRIS_T_DIR,
        .territory = GEN_NPC_KRIS_T_TERRITORY,
    ...
    {
        .id = NPC_MissT,
        .pos = { GEN_NPC_MISS_T_VEC },
        .yaw = GEN_NPC_MISS_T_DIR,
        .territory = GEN_NPC_MISS_T_TERRITORY,
    ...
    {
        .id = NPC_FelissaT,
        .pos = { GEN_NPC_FELISSA_T_VEC },
        .yaw = GEN_NPC_FELISSA_T_DIR,
        .territory = GEN_NPC_FELISSA_T_TERRITORY,
    ...
    },
    {
        ...
        .pos = { GEN_NPC_DOJO_SPECTATOR_VEC },
        .yaw = GEN_NPC_DOJO_SPECTATOR_DIR,
        .territory = GEN_NPC_DOJO_SPECTATOR_TERRITORY,
    ...
    {
        .id = NPC_DojoFan,
        .pos = { GEN_NPC_DOJO_FAN_VEC },
        .yaw = GEN_NPC_DOJO_FAN_DIR,
        .territory = GEN_NPC_DOJO_FAN_TERRITORY,
