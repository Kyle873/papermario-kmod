...
NpcData N(NpcData_Townsfolk)[] = {
    {
        .id = NPC_ChetRippo,
        .pos = { GEN_NPC_CHET_RIPPO_VEC },
        .yaw = GEN_NPC_CHET_RIPPO_DIR,
        .territory = GEN_NPC_CHET_RIPPO_TERRITORY,
    ...
    {
        .id = NPC_NewResident1,
        .pos = { GEN_NPC_NEW_RESIDENT1_VEC },
        .yaw = GEN_NPC_NEW_RESIDENT1_DIR,
        .territory = GEN_NPC_NEW_RESIDENT1_TERRITORY,
    ...
    {
        .id = NPC_NewResident2,
        .pos = { GEN_NPC_NEW_RESIDENT2_VEC },
        .yaw = GEN_NPC_NEW_RESIDENT2_DIR,
        .territory = GEN_NPC_NEW_RESIDENT2_TERRITORY,
    ...
    {
        .id = NPC_ToadKid_03,
        .pos = { GEN_NPC_TOAD_KID_03_VEC },
        .yaw = GEN_NPC_TOAD_KID_03_DIR,
        .territory = GEN_NPC_TOAD_KID_03_TERRITORY,
    ...
    {
        .id = NPC_GossipTrio1,
        .pos = { GEN_NPC_GOSSIP_TRIO1_1_VEC },
        .yaw = GEN_NPC_GOSSIP_TRIO1_1_DIR,
        .territory = GEN_NPC_GOSSIP_TRIO1_1_TERRITORY,
    ...
    {
        .id = NPC_GossipTrio2,
        .pos = { GEN_NPC_GOSSIP_TRIO2_1_VEC },
        .yaw = GEN_NPC_GOSSIP_TRIO2_1_DIR,
        .territory = GEN_NPC_GOSSIP_TRIO2_1_TERRITORY,
    ...
    {
        .id = NPC_GossipTrio3,
        .pos = { GEN_NPC_GOSSIP_TRIO3_1_VEC },
        .yaw = GEN_NPC_GOSSIP_TRIO3_1_DIR,
        .territory = GEN_NPC_GOSSIP_TRIO3_1_TERRITORY,
