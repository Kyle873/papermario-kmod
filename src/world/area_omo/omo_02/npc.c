...
NpcData N(NpcData_ShyGuy_Crowd)[] = {
    ...
    {
        .id = NPC_ShyGuy_06,
        .pos = { GEN_NPC_SHY_GUY_06_VEC },
        .yaw = GEN_NPC_SHY_GUY_06_DIR,
        .territory = GEN_NPC_SHY_GUY_06_TERRITORY,
        .init = &N(EVS_NpcInit_ShyGuy_Crowd),
        .settings = &N(NpcSettings_ShyGuy_Stationary),
        .flags = ENEMY_FLAG_PASSIVE | ENEMY_FLAG_FLYING,
        .drops = NO_DROPS,
    ...
    {
        .id = NPC_ShyGuy_07,
        .pos = { GEN_NPC_SHY_GUY_07_VEC },
        .yaw = GEN_NPC_SHY_GUY_07_DIR,
        .territory = GEN_NPC_SHY_GUY_07_TERRITORY,
        .init = &N(EVS_NpcInit_ShyGuy_Crowd),
        .settings = &N(NpcSettings_ShyGuy_Stationary),
        .flags = ENEMY_FLAG_PASSIVE | ENEMY_FLAG_FLYING,
        .drops = NO_DROPS,
    ...
    {
        .id = NPC_ShyGuy_08,
        .pos = { GEN_NPC_SHY_GUY_08_VEC },
        .yaw = GEN_NPC_SHY_GUY_08_DIR,
        .territory = GEN_NPC_SHY_GUY_08_TERRITORY,
        .init = &N(EVS_NpcInit_ShyGuy_Crowd),
        .settings = &N(NpcSettings_ShyGuy_Stationary),
        .flags = ENEMY_FLAG_PASSIVE | ENEMY_FLAG_FLYING,
        .drops = NO_DROPS,
    ...
    {
        .id = NPC_ShyGuy_09,
        .pos = { GEN_NPC_SHY_GUY_09_VEC },
        .yaw = GEN_NPC_SHY_GUY_09_DIR,
        .territory = GEN_NPC_SHY_GUY_09_TERRITORY,
        .init = &N(EVS_NpcInit_ShyGuy_Crowd),
        .settings = &N(NpcSettings_ShyGuy_Stationary),
        .flags = ENEMY_FLAG_PASSIVE | ENEMY_FLAG_FLYING,
        .drops = NO_DROPS,
    ...
    {
        .id = NPC_ShyGuy_10,
        .pos = { GEN_NPC_SHY_GUY_10_VEC },
        .yaw = GEN_NPC_SHY_GUY_10_DIR,
        .territory = GEN_NPC_SHY_GUY_10_TERRITORY,
        .init = &N(EVS_NpcInit_ShyGuy_Crowd),
        .settings = &N(NpcSettings_ShyGuy_Stationary),
        .flags = ENEMY_FLAG_PASSIVE | ENEMY_FLAG_FLYING,
        .drops = NO_DROPS,
    ...
    {
        .id = NPC_ShyGuy_11,
        .pos = { GEN_NPC_SHY_GUY_11_VEC },
        .yaw = GEN_NPC_SHY_GUY_11_DIR,
        .territory = GEN_NPC_SHY_GUY_11_TERRITORY,
        .init = &N(EVS_NpcInit_ShyGuy_Crowd),
        .settings = &N(NpcSettings_ShyGuy_Stationary),
        .flags = ENEMY_FLAG_PASSIVE | ENEMY_FLAG_FLYING,
        .drops = NO_DROPS,
