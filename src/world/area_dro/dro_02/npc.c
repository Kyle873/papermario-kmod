...
NpcData N(PassiveNPCs)[] = {
    {
        .id = NPC_Archeologist,
        .pos = { GEN_NPC_ARCHEOLOGIST_VEC },
        .yaw = GEN_NPC_ARCHEOLOGIST_DIR,
        .territory = GEN_NPC_ARCHEOLOGIST_TERRITORY,
    ...
    },
    {
        ...
        .pos = { GEN_NPC_DISGUISED_MOUSTAFA_VEC },
        .yaw = GEN_NPC_DISGUISED_MOUSTAFA_DIR,
        .territory = GEN_NPC_DISGUISED_MOUSTAFA_TERRITORY,
    ...
    {
        .id = NPC_Mouser_02,
        .pos = { GEN_NPC_MOUSER_02_VEC },
        .yaw = GEN_NPC_MOUSER_02_DIR,
        .territory = GEN_NPC_MOUSER_02_TERRITORY,
    ...
    {
        .id = NPC_Mouser_03,
        .pos = { GEN_NPC_MOUSER_03_VEC },
        .yaw = GEN_NPC_MOUSER_03_DIR,
        .territory = GEN_NPC_MOUSER_03_TERRITORY,
