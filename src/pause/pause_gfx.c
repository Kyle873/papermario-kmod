...
u8 gPauseMsg_47[] = { 0x21, 0x4C, 0x4C, 0xFD };                                                                               // All Badges[End]
...
u8 gPauseMsg_50[] = { 0x35, 0x53, 0x41, 0x42, 0x4C, 0x45, 0xFD };                                                             // Items[End]
u8 gPauseMsg_4F[] = { 0x2B, 0x45, 0x59, 0xFD };                                                                               // Key Items[End]
